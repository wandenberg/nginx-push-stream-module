...
static const ngx_str_t  NGX_HTTP_PUSH_STREAM_TAG = ngx_string("0.5.3");
static const ngx_str_t  NGX_HTTP_PUSH_STREAM_COMMIT = ngx_string("8ff981d6d51e998fb48fc7592245ab8ec38f9e73");
